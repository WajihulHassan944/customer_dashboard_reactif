  ...
  return (
    <section className="relative min-h-screen px-4 sm:px-6 lg:px-0">
      <Header
        ...
        action={
            <div onClick={()=> router.push('/quotes/new')} className="px-5 py-2.5 bg-blue-600 rounded-lg inline-flex justify-center items-center gap-1.5 cursor-pointer hover:bg-blue-700 transition">
