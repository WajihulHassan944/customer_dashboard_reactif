...
const OrderCard = ({
  ...
  return (
    <Card className="w-full bg-neutral-800 border border-neutral-50/10 rounded-xl px-4 sm:px-6 py-6 flex flex-col gap-8">
...
const Management = () => {
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="w-full mx-auto pb-8 flex flex-col gap-8">
