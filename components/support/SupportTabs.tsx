...
const SupportTabs = ({ activeTab, setActiveTab }: Props) => {
  ...
  return (
    <div className="w-full">
      <div className="w-full flex flex-wrap p-1.5 bg-neutral-200/70 backdrop-blur-sm rounded-full gap-2 shadow-sm">
